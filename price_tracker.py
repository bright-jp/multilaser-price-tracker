...
Info  : https://brightdata.jp/products/insights/price-tracker/multilaser
"""
...
# https://brightdata.jp/products/web-scraper/multilaser
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Multilaser scraper at: https://brightdata.jp/products/web-scraper/multilaser\n"
